// components/StatsView.jsx - TO'G'IRLANGAN
...
const StatsView = ({
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Agar odatlar bo'sh bo'lsa */}
      {habits.length === 0 ? (
        <div className="bg-black/10 backdrop-blur-lg p-8 rounded-3xl text-center">
          <div className="text-6xl mb-4">📊</div>
          <h3 className="text-2xl font-bold text-black mb-2">
            {t.noHabitsYet || "Hozircha odatlar yo'q"}
          </h3>
          <p className="text-gray-700">
            {t.addFirstHabit ||
              "Birinchi odatni qo'shing va statistikani ko'ring"}
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="bg-black/10 backdrop-blur-lg p-6 rounded-3xl">
            ...
            <div className="bg-black/10 w-full m-auto overflow-x-auto rounded-lg p-4">
              <svg
                viewBox="0 0 800 300"
                className="w-full h-auto min-w-150"
              >
                <defs>
                  <linearGradient
                    id="areaGradient"
                  ...
                  <div key={weekIndex} className="bg-black/10 rounded-lg p-4">
                    ...
                    <div className="text-center">
                      <p className="text-sm text-gray-700">
                        ...
                        {t.bajarilgan || "bajarilgan"}
                      </p>
                    </div>
                    <h3 className="text-lg font-bold text-black my-4 text-center">
                      {t.kunlar || "Kunlar"}
                    </h3>
